...
if (idParam != null) {
    try {
        ...
        employee = empService.findEmployeeById(id);
...
<head>
    ...
    <title>Update Employee | EmployeeManager</title>
    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a href="viewsemployee.jsp" class="nav-link"><i class="fas fa-users"></i><span>View Employees</span></a></li>
                <li class="nav-item"><a href="update.jsp" class="nav-link active"><i class="fas fa-user-edit"></i><span>Update Employee</span></a></li>
            ...
            <div class="form-container">
                ...
                <form action="updateemployee" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-input" value="<%= employee.getName() %>" required />
                    </div>

                    <div class="form-group">
                        <label for="address" class="form-label">Address</label>
                        <input type="text" id="address" name="address" class="form-input" value="<%= employee.getAddress() %>" required />
                    </div>
                    
                    <div class="form-group">
						<label for="dob" class="form-label">Date of Birth</label> 
						<input
							type="date" id="dob" name="dob" class="form-input" value="<%= employee.getDob() %>" required />
					</div>

                    <div class="form-group">
                        <label for="yoe" class="form-label">Years of Experience (YOE)</label>
                        <input type="number" step="0.1" id="yoe" name="yoe" class="form-input" value="<%= employee.getYoe() %>" required />
                    </div>

                    <div class="form-group">
                        <label for="salary" class="form-label">Salary (in ₹)</label>
                        <input type="number" step="0.01" id="salary" name="salary" class="form-input" value="<%= employee.getSalary() %>" required />
                    </div>

                   <%--  <div class="form-group">
                        <label for="age" class="form-label">Age</label>
                        <input type="number" id="age" name="age" class="form-input" value="<%= employee.getAge() %>" required />
                    </div> --%>

                    <div class="form-group">
                        <label for="reportingManager" class="form-label">Reporting Manager</label>
                        <input type="text" id="reportingManager" name="reportingManager" class="form-input" value="<%= employee.getReportingManager() %>" required />
                    </div>
