	...
	<div class="container">
		...
		<aside class="sidebar">
			...
			<ul class="nav-menu">
				...
				<li class="nav-item"><a href="registeremployee.jsp"
					class="nav-link active"><i class="fas fa-user-plus"></i><span>Register
							Employee</span></a></li>
				<li class="nav-item"><a href="viewsemployee.jsp"
					class="nav-link"><i class="fas fa-users"></i><span>View
							Employees</span></a></li>
				<li class="nav-item"><a href="updateemployee.jsp"
		...
		<main class="main-content">
			...
			<div class="form-container">
				...
				<form action="rgisteremployee" method="post">
					<div class="form-group">
						<label for="name" class="form-label">Employee Name</label> <input
							type="text" id="name" name="name" class="form-input" required />
					</div>
					...
					<div class="form-group">
						<label for="dob" class="form-label">Date of Birth</label> <input
							type="date" id="dob" name="dob" class="form-input" required />
					</div>


					<div class="form-group">
						<label for="yoe" class="form-label">Years of Experience
							(YOE)</label> <input type="number" step="0.1" id="yoe" name="yoe"
							class="form-input" required />
					</div>

					<div class="form-group">
						<label for="salary" class="form-label">Salary (in ₹)</label> <input
							type="number" step="0.01" id="salary" name="salary"
							class="form-input" required />
					</div>

					<!-- <div class="form-group">
						<label for="age" class="form-label">Age</label> <input
							type="number" id="age" name="age" class="form-input" required />
					</div> -->

					<div class="form-group">
						<label for="reportingManager" class="form-label">Reporting
							Manager</label> <input type="text" id="reportingManager"
							name="reportingManager" class="form-input" required />
					</div>
